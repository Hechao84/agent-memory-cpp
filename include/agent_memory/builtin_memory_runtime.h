...
public:
    ...
    MemoryConsolidationResult Consolidate(const MemoryConsolidationRequest& request, MemoryModelClient* model) override;
    MemorySearchResult SearchMemory(const MemorySearchRequest& request) override;
